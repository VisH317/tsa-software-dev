    ...
    return (
        <div className={`h-screen w-screen flex flex-row divide-x divide-slate-300 bg-slate-50 ${montserrat.variable} font-sans`}>
            <div className="w-1/2 p-10 relative">
                ...
                <div className="h-6"/>
                <textarea className="p-5 bg-transparent outline-none border-slate-400 border-2 hover:border-green-500 focus:border-green-500 w-[90%] h-[70%] duration-300" placeholder="Question: " value={question} onChange={e => setQuestion(e.target.value)}/>
                <div className="h-10"/>
